...
const SlideList = [
  {
    ...
    buttonText: content.orderButton,
    buttonLink: "/contact",
  },
];
  ...
  render(){
    ...
    return(
      <Fragment> 
        ...
        <HeaderTwo logo={content.logoDark} color="color-black"/>
        
        {/* Start Slider Area */}
        <div className="slider-wrapper">
          {/* Start Single Slide */}
          {SlideList.map((value , index) => (
            <div className="slide personal-portfolio-slider slider-paralax slider-style-3 d-flex align-items-center justify-content-center bg_image bg_image--10" key={index}>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                    ...
                    <p dangerouslySetInnerHTML={{ __html: content.portfolio.description }}></p>
                  </div>
                </div>
              </div>
              <div className="row">
